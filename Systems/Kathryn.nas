...
##
## Modified for Skipjack Kathryn by Jeffery S. Koppe
...
var _Kathryn_initialized = 0;
setlistener("/sim/signals/fdm-initialized", func {
    if (_Kathryn_initialized) return;
    aircraft.livery.init("Aircraft/Kathryn/Models/Liveries");
    settimer(ground, 0.0);
    print("Hydrodynamics initialized.");
    _Kathryn_initialized = 1;
});
